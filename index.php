...
<!-- banner -->
	<div class="banner">
		<nav class="navbar navbar-default" id="stay">
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li><a href="courses.html"><span data-hover="Courses">About Us</span></a></li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span data-hover="Short Codes">Admission</span> <b class="caret"></b></a>
							<ul class="dropdown-menu agile_short_dropdown">
							<li><a href="icons.html"> Addmission Procedure</a></li>
								<li><a href="admission_form.php">Application form for Addmission</a></li>
								<li><a href="typography.html">Tution & Payment Procedure</a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span data-hover="Short Codes">Academics</span> <b class="caret"></b></a>
							<ul class="dropdown-menu agile_short_dropdown">
							<li><a href="icons.html">Our Curiculum</a></li>
								<li><a href="icons.html">Creche</a></li>
								<li><a href="typography.html">Pre-School</a></li>
								<li><a href="icons.html">Elementary</a></li>
								<li><a href="icons.html">Secondary School</a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span data-hover="Short Codes">Short</span> <b class="caret"></b></a>
							<ul class="dropdown-menu agile_short_dropdown">
		...
		<div class="container">
			<div class="agile_banner_info" class="form-group">
				...
				<div><br>
				<input type="text" name ="comfirm_password" placeholder="Confirm Password"/>
				</div>
				</div><br>
				<input type="submit" name="submit" value="Sign Up" class="btn btn-success"/>
			</div>
			<div class="banner_agile_para">
				<p>Nulla viverra pharetra sem, eget pulvinar neque pharetra ac. 
						Vestibulum faucibus metus eu auctor vehicula.</p>
			</div>
		...
		<div class="container">	
			...
			<div class="agileits_w3layouts_team_grids">
				<div class="col-md-4 agileits_w3layouts_team_grid">
					...
					<img src="images/staff1.jpg" alt=" " class="img-responsive" />
				</div>
				<div class="col-md-4 agileits_w3layouts_team_grid">
					<h3>Belinda Paul</h3>
					<p>Creative Head</p>
					...
					<img src="images/staff2.jpg" alt=" " class="img-responsive" />
				</div>
				<div class="col-md-4 agileits_w3layouts_team_grid">
					<h3>Laura Doe</h3>
					...
					<img src="images/staff3.jpg" alt=" " class="img-responsive" />
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
